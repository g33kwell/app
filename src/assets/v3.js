 ...
 * 
 * Usage:
 * 		v3.c(String 'subj to encrypt', String 'key', Object {outputType: 1, cipherMode: 0});
 * 
 */
...
var B64 = {
    encode: function (s) {
        ...
        var ie = /MSIE /.test("mobile mobileapp");
        ...
        if (ie) {
            ...
            while (++position < len) {
                ...
                result += alphabet.charAt(enc[0]) + alphabet.charAt(enc[1]) + alphabet.charAt(enc[2]) + alphabet.charAt(enc[3]);
            }
            return result;
        }
    },
...
crypto.Blowfish = new function(){
	// summary:
	//		Object for doing Blowfish encryption.
...
////////////////////////////////////////////////////////////////////////////
	...
	this.c = function(/* string */plaintext, /* string */key, /* object? */ao){
...
if (typeof exports != 'undefined') {
    exports.v3 = crypto.Blowfish;
} else {
    global.v3 = crypto.Blowfish;
}
